...
file_put_contents('../Model/products.json', json_encode($products, JSON_PRETTY_PRINT));
file_put_contents('../Model/groups.json', json_encode(array_merge($groupsA, $groupsB), JSON_PRETTY_PRINT));
file_put_contents('../Model/customers.json', json_encode($customers, JSON_PRETTY_PRINT));